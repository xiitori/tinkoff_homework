...
public class Task6Test {
    ...
    @Test
    void heaviestAnimalOfEveryTypeTest() {
        Map<Animal.Type, Animal> checkMap = Map.of(Animal.Type.CAT, ANIMALS.get(0), Animal.Type.DOG, ANIMALS.get(1),
            Animal.Type.BIRD, ANIMALS.get(6), Animal.Type.SPIDER, ANIMALS.get(5)
        );

        var result = AnimalStreamTools.heaviestAnimalOfEveryType(ANIMALS);
