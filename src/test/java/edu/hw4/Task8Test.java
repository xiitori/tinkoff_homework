...
public class Task8Test {
    ...
    @Test
    void mostHeaviestUnderKTest() {
        var result = AnimalStreamTools.mostHeaviestUnderK(ANIMALS, 40);

        assertThat(result.get().name()).isEqualTo("laki");
    }

    @Test
    void kIsLseThanAnyHeight() {
        var result = AnimalStreamTools.mostHeaviestUnderK(ANIMALS, 0);
